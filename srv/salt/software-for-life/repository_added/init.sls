...
{% if grains['cpuarch'] == 'armv7l' %}
  ...
  {% elif grains['lsb_distrib_codename'] == 'openSUSE Leap 15.1' %}
        https://download.opensuse.org/repositories/home:/binary_sequence:/software-for-life/openSUSE_Leap_15.1_ARM/
  {% endif %}
{% elif grains['cpuarch'] == 'x86_64' %}
  ...
  {% elif grains['lsb_distrib_codename'] == 'openSUSE Leap 15.1' %}
        https://download.opensuse.org/repositories/home:/binary_sequence:/software-for-life/openSUSE_Leap_15.1/
